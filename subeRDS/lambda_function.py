...
def lambda_handler(event, context):
    ...
    try:
        ...
        db_instances_with_status = filter(lambda instance: instance["DBInstanceStatus"] == "stopped", db_instances)
        ...
        for db_instance in db_instances_with_status:
            ...
            db_instance_action_response = rds.start_db_instance(DBInstanceIdentifier=db_instance_id)

            if db_instance_action_response:
                logger.info(f"Iniciando RDS {db_instance['DBInstanceIdentifier']}.")
